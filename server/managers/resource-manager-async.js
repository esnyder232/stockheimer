...
const {CharacterclassResourceAsyncDefinition} = require("../resource-definition/character-class-resource-async-definition.js");


/*
This is the "async" version of the resource manager. It basically does the same thing as the resource-manager, but doesn't rely on a gameloop update. It just reads the files and loads/links them as fast as possible.
*/
...
class ResourceManagerAsync {
	...
	init(gameServer) {
		...
		this.resourceDefinitions["character-class"] = new CharacterclassResourceAsyncDefinition();
