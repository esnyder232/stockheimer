...
const {HitscanResourceDefinition} = require("../resource-definition/hitscan-resource-definition.js");
...
class ResourceManager {
	...
	init(gameServer) {
		...
		this.resourceDefinitions["hitscan"] = new HitscanResourceDefinition();
